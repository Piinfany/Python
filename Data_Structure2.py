...
class Stack:
    ...
    def peek(self):
        return self.items[len(self.items)-1] # คืนค่าข้อมูลที่อยู่ที่ตำแหน่งสุดท้ายของ list 
...
class Queue:
    ...
    def enqueue(self, item):
        self.items.insert(0,item) # เพิ่มข้อมูลเข้าไปใน Queue จะะใช้ insert ที่ต าแหน่ง 0 เวลาที่เพิ่มข้อมูลใหม
    def dequeue(self):
        return self.items.pop() # นำข้อมูลที่อยู่ตำแหน่งแรกสุด(นำเข้ามาอันแรก)ออกไป และใช้ pop เวลาเอาข้อมูลออก
